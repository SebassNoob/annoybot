...
# autoresponse table
res= server_conn.execute("SELECT id, autoresponse_content FROM serverSettings").fetchall()
...
for row in res:
    ...
    with open('dump/autoresponse_dump.sql', 'a', encoding='utf-8') as f:
        for key, value in autores_dict.items():
            ...
            v = f'\'{v[1:-1]}\''
            f.write(f"INSERT INTO autoresponse (server_id, msg, response) VALUES ({server_id!r}, {k}, {v});\n")
...
for row in res:
    ...
    with open('dump/server_settings_dump.sql', 'a', encoding='utf-8') as f:
        f.write(f"INSERT INTO server_settings (id, autoresponse_on) VALUES ({server_id!r}, {autores_on!r});\n")
...
for row in res:
    ...
    with open('dump/user_settings_dump.sql', 'a', encoding='utf-8') as f:
        f.write(f"INSERT INTO user_settings (id, color, family_friendly, sniped, block_dms) VALUES ({user_id!r}, {color!r}, {family_friendly!r}, {sniped!r}, {block_dms!r});\n")
...
for row in res:
    ...
    for user_id in blacklist:
        with open('dump/user_server_dump.sql', 'a', encoding='utf-8') as f:
            f.write(f"INSERT INTO user_server (server_id, user_id, blacklist) VALUES ({server_id!r}, {user_id!r}, 1);\n")
